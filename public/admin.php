...
<header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0">
  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-center text-uppercase fw-bold" href="/">The Story Sage</a>
  ...
  <div class="navbar-nav">
    <div class="nav-item text-nowrap">
      <a class="nav-link px-3 text-white" href="logout">Log out</a>
    </div>
  </div>
</header>
